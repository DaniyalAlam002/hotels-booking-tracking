        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-2xl font-bold">Luxury Hotels</span>
            </div>
            <p className="text-gray-300 mb-6 max-w-md">
              Experience world-class hospitality and luxury accommodations. Book your perfect stay with us and create unforgettable memories.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/query" className="text-gray-300 hover:text-white transition-colors duration-200">
                  Send Query
                </Link>
              </li>
              <li>
